...
Der Entwicklungsprozes dieser Modelle folgt hauptsächlich dem Ablauf von Pre-training und Fine-tuning.
Im Rahmen des Pre-trainings lernen die LLMs durch selbstüberwachtes Lernen, indem sie beispielsweise fehlende Wörter in Datensätzen von zum Beispiel Wikipedia-Dateien vorhersagen.
